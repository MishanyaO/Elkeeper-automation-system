...
function OrderList({ clickHandler }) {
  ...
  const columns = useMemo(() => [
    ...
    {
      field: 'title', headerName: 'title', width: 260, filterable: false, editable: false,
    },
    {
      field: 'quantity', headerName: 'amount', width: 70, filterable: false, editable: false,
    },
    {
      field: 'price', headerName: 'price', width: 80, filterable: false, editable: false,
    },
    {
      field: 'actions ',
      headerName: 'delete',
